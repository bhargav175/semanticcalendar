...
//Tags Columns
  ...
  //CheckList
    ...
    public static final String HABIT_END_DATE="endDate";
 ...
 private static final String CREATE_TABLE_HABITS = "create table if not exists "
            ...
            + HABIT_START_DATE + " DATETIME DEFAULT (DATETIME(current_timestamp, 'localtime')), "
            + HABIT_END_DATE + " DATETIME DEFAULT (DATETIME(current_timestamp, 'localtime')), "
