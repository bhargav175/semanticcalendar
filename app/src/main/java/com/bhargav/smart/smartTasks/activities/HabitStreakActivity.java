...
import com.bhargav.smart.smartTasks.helpers.HabitButton;
...
public class HabitStreakActivity extends Activity {
    ...
    private Boolean getIsHabitDueToday(){
        ...
        Integer habitDurationCountVal =daysBetween(habitCurrent.getEndDate(),habitCurrent.getStartDate());
    ...
    private void initUi(){
        ...
        if(habitCurrent.getStartDate()==null){
