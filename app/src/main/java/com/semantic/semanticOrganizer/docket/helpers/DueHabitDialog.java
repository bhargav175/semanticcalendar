...
public class DueHabitDialog extends AlertDialog.Builder {
    ...
    public DueHabitDialog(final FragmentActivity a, final Calendar c, final TextView textView, int y, int M, int d, int h, int m, final Boolean hasReminder, Integer reminderId) {
        super(a);
